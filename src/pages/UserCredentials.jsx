      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-gray-100 p-5 md:p-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-black text-slate-800 uppercase italic leading-none">Guest Registration</h2>
              <p className="text-slate-400 text-xs md:text-sm font-medium mt-1">Step {page} of 3</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-8 md:space-y-6">
                {formData.guests.map((guest, index) => (
                    <div key={index} className="p-4 md:p-5 bg-slate-50 border border-slate-200 rounded-3xl space-y-4 relative">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-6 border-t border-slate-100">
            ...
            {page < 3 ? (
              <button type="button" onClick={() => setPage(page + 1)} className="order-1 sm:order-2 flex-[2] py-4 bg-blue-600 text-white rounded-xl font-black shadow-lg shadow-blue-200 hover:bg-blue-700 transition-all uppercase text-[10px] md:text-xs tracking-widest">Next Step</button>
            ) : (
              <button type="submit" className="order-1 sm:order-2 flex-[2] py-4 bg-emerald-600 text-white rounded-xl font-black shadow-lg shadow-emerald-200 hover:bg-emerald-700 transition-all uppercase text-[10px] md:text-xs tracking-widest">Complete Registration</button>
            )}
          </div>
        </form>
      </div>
